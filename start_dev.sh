...
if ! redis-cli ping > /dev/null 2>&1; then
    echo "⚠️  Redis n'est pas accessible sur localhost:6382"
    echo "Veuillez démarrer Redis ou utiliser Docker:"
    echo "docker run --name redis -p 6382:6379 -d redis:7-alpine"
    echo ""
...
echo "   - Application web: http://localhost:8003"
echo "   - Admin Django: http://localhost:8003/admin/"
echo "   - API Swagger: http://localhost:8003/swagger/"
echo ""
